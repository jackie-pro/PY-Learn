...
out_temp_file1 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-temp.txt','w', encoding = 'utf8')
...
#=======
#移除第一行標頭 txt -> txt
# (score-temp.txt -> score-temp1.txt)
in_temp_csvfile1 = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\score-temp.txt',encoding = 'utf8')
print(in_temp_csvfile1)
out_tmp_csvfile1 = in_temp_csvfile1.drop(in_temp_csvfile1.index[0]) #去掉第一個
print(out_tmp_csvfile1)
out_tmp_csvfile1.to_csv(r'C:\GitHub\python\PY-Learn\oil-project\score-temp1.txt',encoding='utf8',)
#=======
#===製作下次加油累積公里數 txt -> txt
# (score-temp1.txt -> score-temp2.txt)
#因為要把下一次加油的公里數取出來 這一次公里數相減 得出 這次加油後 跑了多少公里
in_temp_file1 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-temp1.txt','r',encoding='utf8',)
line2 = in_temp_file1.readline()
out_temp_file2 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-temp2.txt','w', encoding = 'utf8')
...
out_temp_file4 = open(r'C:\GitHub\python\PY-Learn\oil-project\new-score.csv','w', encoding = 'utf8')
...
out_temp_file5 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-temp3.csv','w', encoding = 'utf8')
while line3 != '':
    print(line3)
    data3 = line3.split('-')
    print('data3 = ',data3)
...
# (new-score.csv -> score-temp4.csv)
in_temp_csvfile2 = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\new-score.csv', encoding = 'utf8')
out_temp_csvfile2 = in_temp_csvfile2.groupby(['year']).sum() #合併種類的名稱，並且顯示該名稱欄位的所有數量總合
out_temp_csvfile2.to_csv(r'C:\GitHub\python\PY-Learn\oil-project\score-temp4.csv',encoding='utf8',)
print(out_temp_csvfile2)
#=======
#移除第一行標頭 txt -> txt
# (score-cost.txt -> score-cost-temp.txt)
csvRows1 = []
...
out_tmp_csvfile3  = open(r'C:\GitHub\python\PY-Learn\oil-project\score-cost-temp.txt','w', encoding='utf8',newline='')
...
#==處理所需資料 txt -> txt
#算出6年以來所有相關機車維修保養險費用
# (score-cost-temp.txt -> sumcost)
in_score_file3 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-cost-temp.txt','r', encoding = 'utf8')
...
#=======
#移除第一行標頭 csv -> csv
# (score-temp4.csv -> new-score1.csv)
csvRows2 = []
in_temp_csvfile4 = open(r'C:\GitHub\python\PY-Learn\oil-project\score-temp4.csv', 'r' ,encoding='utf8')
...
out_tmp_csvfile4  = open(r'C:\GitHub\python\PY-Learn\oil-project\new-score1.csv','w', encoding='utf8',newline='')
...
#========================= 
# (new-score1.csv -> new-score1.txt
#                 -> new-score2.txt)
in_score_file4 = open(r'C:\GitHub\python\PY-Learn\oil-project\new-score1.csv','r',encoding='utf8')
line6 = in_score_file4.readline()
out_temp_file6 = open(r'C:\GitHub\python\PY-Learn\oil-project\new-score1.txt','w', encoding = 'utf8')
out_temp_file7 = open(r'C:\GitHub\python\PY-Learn\oil-project\new-score2.txt','w', encoding = 'utf8')
while line6 != '':
    data5 = line6.split(',')
...
out_open_score_file1 = open(r'C:\GitHub\python\PY-Learn\oil-project\open-score-temp.csv','w', encoding = 'utf8')
while line7 != '':
    data6 = line7.split(',')
    day2 = data6[0] #取出調價日期
...
#=======
#移除第一行標頭 csv -> csv
# (open-score-temp.csv -> new-open-score.csv)
csvRows3 = []
in_temp_csvfile5 = open(r'C:\GitHub\python\PY-Learn\oil-project\open-score-temp.csv', 'r' ,encoding='utf8')
...
out_tmp_csvfile5  = open(r'C:\GitHub\python\PY-Learn\oil-project\new-open-score.csv','w', encoding='utf8',newline='')
...
#========================= 
#依年份取出
in_open_score_file2 = open(r'C:\GitHub\python\PY-Learn\oil-project\new-open-score.csv', 'r' ,encoding='utf8')
line8 = in_open_score_file2.readline()
out_temp_open_score_file1 = open(r'C:\GitHub\python\PY-Learn\oil-project\open-score-temp.csv', 'w' ,encoding='utf8')
while line8 != '':
    print(line8)
    data7 = line8.split(',')
    print(data7)
...
oil = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\score-temp3.csv', names = colName3)
colName4 = ['年度', '95無鉛汽油油價']
oil1 = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\open-score-temp.csv', names = colName4)
...
cost = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\new-score1.txt', names = colName1)
...
time = pd.read_csv(r'C:\GitHub\python\PY-Learn\oil-project\new-score2.txt', names = colName2)
